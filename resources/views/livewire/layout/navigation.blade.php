    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 shadow-sm">
        <div class="flex justify-between h-16">
            ...
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    <x-nav-link :href="route('course')" :active="request()->routeIs('course')" wire:navigate>
                        {{ __('Kelas') }}
                    </x-nav-link>
                </div>
            </div>
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6">
                @if (auth()->check())
                    <x-dropdown align="right" width="48">
                        <x-slot name="trigger">
                            <button
                                class="inline-flex items-center px-3 py-2 border border-transparent text-sm leading-4 font-medium rounded-md   bg-cyan-500 text-neutral-100 hover:bg-cyan-700 focus:outline-none transition ease-in-out duration-150">
                ...
                @else
                    <a href="{{ route('login') }}" wire:navigate class="px-4 py-1 text-sm bg-neutral-300 rounded-lg">
                        Login
                    </a>
                @endif
            </div>
